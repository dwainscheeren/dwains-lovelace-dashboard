  ...
  `;static get properties(){return{_hass:{},_config:{},notifications:{type:Array}}}setConfig(e){this.config=e}set hass(e){this._hass=e,this.requestUpdate()}constructor(){super(),this.notifications=[]}connectedCallback(){super.connectedCallback(),this._unsub||(this._subscribeNotifications(),this._notificationsUpdated())}async _subscribeNotifications(){this._unsub||(this._unsub=await this._hass.connection.subscribeEvents((()=>this._notificationsUpdated()),"dwains_dashboard_notifications_updated"))}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=void 0)}async _notificationsUpdated(){this.notifications=await this._hass.callWS({type:"dwains_dashboard_notification/get"})||[],this.requestUpdate()}_handleDismiss(e){this._hass.callService("dwains_dashboard","notification_dismiss",{notification_id:e}),this._notificationsUpdated()}_renderNotification(t){return e.qy`
    ...
    `:e.qy``}}customElements.define("dwains-notification-card",t)})(),(()=>{"use strict";var e=i(845),t=i(752),a=i(576),n=i(924),o=i(153),s=i(969),r=i(177),l=i(89);class d extends e.WF{static get styles(){return e.AH`
      ...
      `}_renderPersonCard(t){const i=this._hass.states[t];if(i&&i.attributes){let a=i.attributes.entity_picture_local||i.attributes.entity_picture;a&&this._hass&&(a=this._hass.hassUrl(a));const n=void 0===i.attributes.friendly_name?i.entity_id.replace(/_/g," "):i.attributes.friendly_name;return e.qy`
            ...
            `:e.qy``}}customElements.define("dwains-house-information-card",d)})(),(()=>{"use strict";var e=i(845),t=i(89),a=i(177);class n extends e.WF{static get styles(){return e.AH`
        .p-20px {
            padding: 20px;
        }
        .flex {
        ...
        `}static get properties(){return{_hass:{},configuration:{},areas:{type:Object}}}constructor(){super(),this.areas={}}set hass(e){this._hass=e}async setConfig(e){if(!e.entities)throw new Error("Specify entities list");this._config=e,this.entities=e.entities,this.domain=e.domain,this.deviceClass=e.deviceClass,this.cardHelpers=await window.loadCardHelpers(),await this.loadCards()}async loadCards(){for(const e of this.entities){const t=await this.createEntityCard(e.entity_id);if(t){const i=e.area.area_id||"default";this.areas[i]||(this.areas[i]={cards:[],name:i}),this.areas[i].cards.push(t)}}this.requestUpdate()}async createEntityCard(e){const t=this._hass.states[e],i=e.substr(0,e.indexOf(".")),a="test";if(!t)return null;let n={};switch(i){default:n={type:"tile",name:a};break;case"camera":n={type:"picture-entity",camera_view:"live"},rowSpan="2",colSpan="2",rowSpanLg="2",colSpanLg="2",rowSpanXl="2",colSpanXl="2";break;case"climate":n={type:"thermostat",name:a,features:[{type:"climate-fan-modes",fan_modes:["quiet","low","medium","high"]},{type:"climate-hvac-modes",hvac_modes:["heat_cool","heat","dry","fan_only","cool","off"]}]};break;case"cover":n={type:"tile",name:a,features:[{type:"cover-open-close"},{type:"cover-position"}]};break;case"light":n={type:"tile",name:a,features:[{type:"light-brightness"}]}}n={entity:e,...n};const o=await this.cardHelpers.createCardElement(n);return o.hass=this._hass,o}_navigateToDevices(e){const i=e.currentTarget.domain;let a;(0,t.f)();let n=window.location.pathname,o=n.substring(0,n.lastIndexOf("/"))+"/devices#"+i;window.history.pushState(null,"",o),a=new Event("location-changed",{composed:!0}),a.detail={replace:!1},window.dispatchEvent(a)}_handleTurnAllOffClicked(e){const i=this._currentOn();0==i.length&&(0,t.f)(),i.map((e=>{const t=e.stateObj.entity_id,i=computeDomain(t),a="group"===i?"homeassistant":i;let n;switch(i){case"lock":n="lock";break;case"cover":n="close_cover";break;default:n="turn_off"}this._hass.callService(a,n,{entity_id:t})}))}render(){if(!this._hass||!this._config||0===Object.keys(this.areas).length)return e.qy``;let t=!1;return"light"!=this.domain&&"switch"!=this.domain||(t=!0),e.qy`
            <div class="p-20px">
